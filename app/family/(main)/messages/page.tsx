                  ...
                  return (
                    <div key={m.id} className={`flex gap-3 ${isGrandma ? '' : 'flex-row-reverse'}`}>
                      ...
                      <div className={`min-w-0 flex-1 space-y-2 ${isGrandma ? '' : 'text-right'}`}>
                        ...
                        <div
                          className={`block w-fit max-w-full rounded-2xl border border-line bg-card px-4 py-3 text-sm text-ink ${isGrandma ? '' : 'ml-auto'} ${isGrandma ? 'rounded-tl-sm' : 'rounded-tr-sm'}`}
                        >
                          {m.original_text}
                        </div>
                        <div
                          className={`block w-fit max-w-full rounded-2xl px-4 py-3 text-left text-sm text-white ${isGrandma ? '' : 'ml-auto'} ${isGrandma ? 'rounded-tl-sm bg-brand' : 'rounded-tr-sm bg-sage'}`}
                        >
